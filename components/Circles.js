...
const Circles = () => {
  return (
    <div className="absolute w-full h-full animate-spin-slow top-0 z-[1] transition duration-300">
      ...
      <div className="absolute h-[120px] w-[120px] bg-teal-500 rounded-full left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 transition duration-300 bg-opacity-40 blur-md animate-pulse"></div>
