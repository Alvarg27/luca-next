...
const HeroSection = () => {
  ...
  return (
    ...
    >
      <div className="max-w-[1200px] w-[90%] relative z-[1] flex-col md:flex-row flex md:mt-[0px]  -mt-[60px] pt-32 md:pt-12">
        <div className="w-full lg:pr-4 flex items-center md:h-[500px] h-[300px] justify-center">
