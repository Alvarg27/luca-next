...
const InfoCard = () => {
  return (
    <div className="w-[90%] text-lg">
      ...
      <div>
        <div className="flex">
          <div className="mr-1 flex-1 bg-amber-300 rounded-2xl p-4  flex flex-col justify-between">
          ...
          <div
            className="ml-1 flex-1 bg-indigo-300
        ...
        <div className="mt-2 flex-1 bg-blue-300 rounded-2xl p-4 flex flex-col justify-between">
